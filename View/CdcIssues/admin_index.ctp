...
<div id="CdcIssuesAdminIndex">
    ...
    <div class="btn-group">
        ...
        <?php echo $this->Html->link('匯出', array('action' => 'export', 3), array('class' => 'btn btn-secondary')); ?>
    </div>
            ...
            <tr<?php echo $class; ?>>
                ...
                <td>
                    <div class="btn-group" role="group">
                        <?php echo $this->Html->link('編輯', array('action' => 'edit', $item['CdcIssue']['id']), array('class' => 'btn btn-secondary')); ?>
                        <?php echo $this->Html->link('刪除', array('action' => 'delete', $item['CdcIssue']['id']), array('class' => 'btn btn-secondary'), '確定刪除？'); ?>
                    </div>
                </td>
            </tr>
