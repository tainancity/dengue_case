...
var styleWork = new ol.style.Style({
    image: new ol.style.FontSymbol({
        glyph: 'fa-wrench',
        radius: 12,
        fill: new ol.style.Fill({
...
var vectorWork = new ol.layer.Vector({
    source: new ol.source.Vector({
        url: cakeRoot + 'points/json/work',
        format: new ol.format.GeoJSON()
    }),
    style: styleWork
});

var vectorActivity = new ol.layer.Vector({
    source: new ol.source.Vector({
        url: cakeRoot + 'points/json/activity',
        format: new ol.format.GeoJSON()
    }),
    style: styleActivity
});
...
var map = new ol.Map({
    layers: [baseLayer, vectorPoints, vectorCase, vectorWork, vectorActivity, cunli],
    target: 'map',
    view: appView
});
