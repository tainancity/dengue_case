    ...
    public function export($model = '', $theDate = '') {
        ...
        switch ($model) {
            case 'Expand':
                ...
                $expands = $this->Area->Expand->find('all', array(
                    'conditions' => array(
            ...
            case 'Fever':
                ...
                $fevers = $this->Area->Fever->find('all', array(
                    'conditions' => array(
            ...
            case 'Track':
                ...
                $tracks = $this->Area->Track->find('all', array(
                    'conditions' => array(
            ...
            case 'Education':
                ...
                $educations = $this->Area->Education->find('all', array(
                    'conditions' => array(
            ...
            case 'BureauSource':
                ...
                $bureauSources = $this->BureauSource->find('all', array(
                    'conditions' => array(
            ...
            case 'Chemical':
                ...
                $chemicals = $this->Area->Chemical->find('all', array(
                    'conditions' => array(
            ...
            case 'FeverMonitor':
                ...
                $feverMonitors = $this->Area->FeverMonitor->find('all', array(
                    'conditions' => array(
            ...
            case 'ClinicReport':
                ...
                $clinicReports = $this->Area->ClinicReport->find('all', array(
                    'conditions' => array(
